						...
						<form action="{{ route('contactos.update') }}" method="POST" class="form" id="formContact">
							...
							<div class="row">
								...
								<div class="form-group col-12">
									...
									<textarea class="form-control @error('schedule') is-invalid @enderror" name="schedule" placeholder="Introduzca el horario de atención" id="content-schedule">{{ $setting->schedule }}</textarea>
								</div>
