		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				...
				<div class="text-center user-info">
					...
					<p class="mb-0">{{ $payment->user()->withTrashed()->first()->name." ".$payment->user()->withTrashed()->first()->lastname }}</p>
					@if(!is_null($payment->user()->withTrashed()->first()) && !is_null($payment->user()->withTrashed()->first()->dni))
					<span class="font-weight-bold">{{ $payment->user()->withTrashed()->first()->dni }}</span>
					@endif
				</div>
				...
				<div class="user-info-list">
					...
					<div class="">
						<ul class="contacts-block list-unstyled mw-100 mx-2">
							...
							<li class="contacts-block__item">
								<span class="h6 text-black"><b>Envío:</b> {{ "$".number_format($payment->delivery, 2, ",", ".") }}</span>
							</li>
							<li class="contacts-block__item">
