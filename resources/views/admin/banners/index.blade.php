							...
							<table class="table table-hover table-export">
								<thead>
									<tr>
										...
										<th>Banner</th>
										<th>Estado</th>
										@if(auth()->user()->can('banners.edit') || auth()->user()->can('banners.active') || auth()->user()->can('banners.deactive') || auth()->user()->can('banners.delete'))
										<th>Acciones</th>
										@endif
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										<td>{{ $num++ }}</td>
										<td class="d-flex">
											<img src="{{ image_exist('/admins/img/banners/', $banner->image, false, false) }}" class="rounded-circle mr-2" width="45" height="45">
										</td>
