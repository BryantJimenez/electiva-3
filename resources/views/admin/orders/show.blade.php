		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				...
				<div class="text-center user-info">
					...
					@if(!is_null($order->user()->withTrashed()->first()) && !is_null($order->user()->withTrashed()->first()->dni))
					<span class="font-weight-bold">{{ $order->user()->withTrashed()->first()->dni }}</span>
					@endif
				</div>
									...
									<table class="table table-normal table-hover">
										...
										<tbody>
											...
											<tr>
												<td>{{ $num++ }}</td>
												<td>
													{{ $item->product()->withTrashed()->first()->name }}
												</td>
												<td>{{ $item->qty }}</td>
